...
class GoogleToken < ConsumerToken
  ...
  def self.get_request_token(callback_url, scope=nil)
    consumer.get_request_token({:oauth_callback=>callback_url},
            :scope=>scope||credentials[:scope]||"http://www-opensocial.googleusercontent.com/api/people")
  end
  ...
  def google_calendar
    @access_token.get("https://www.google.com/calendar/feeds/default/owncalendars/full")
  end
